...
function renderPrice() {
  ...
  if (state.mushrooms) {
    document.querySelector('aside ul').innerHTML += `<li>${ingredients.mushrooms.price} mushrrom</li>`;
    totalPrice += ingredients.mushrooms.price;
  }

  if (state.greenPeppers) {
    document.querySelector('aside ul').innerHTML += `<li>${ingredients.greenPeppers.price} green pepper</li>`;
...
document.querySelector('.btn.btn-pepperoni').addEventListener('click', () => {   //why .btn.btn and not just .btn??
